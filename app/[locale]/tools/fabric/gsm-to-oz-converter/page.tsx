...
import { GSMToOzConverter } from '@/components/calculators/GSMToOzConverter';
...
export async function generateMetadata({
  ...
  const t = await getTranslations('tools.gsmToOzConverter');

  return generateToolMetadata({
    locale,
    seoTitle: t('seoTitle'),
    seoDescription: t('seoDescription'),
    toolPath: 'fabric/gsm-to-oz-converter',
    keywords: ['GSM converter', 'Oz/yd² converter', 'fabric weight', 'unit conversion'],
  });
}

export default async function GSMToOzConverterPage({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
